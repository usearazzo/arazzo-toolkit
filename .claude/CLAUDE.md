...
- **`skills/`** — invokable slash commands. `/review-community` reviews someone else's PR with the diplomatic tone in `output-styles/review-comments.md`.
