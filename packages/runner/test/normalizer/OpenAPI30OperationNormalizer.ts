...
import { isOperationElement, type OperationElement } from '@speclynx/apidom-ns-openapi-3-0';
...
describe('OpenAPI30OperationNormalizer', function () {
  ...
  context('given OpenAPI document with circular schema references', function () {
    ...
    specify('should not throw on circular schemas', async function () {
      const operation = extractAs30(extractor, circularDoc, 'getNodes');
